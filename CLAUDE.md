...
- Шрифты: СЕЙЧАС Archivo (sans/display) + Space Mono (mono) через next/font. **Направление по якорю aboutluca → перейти на IBM Plex Mono** (pending, нужен «ок» владельца — ре-тайпсет всего сайта).
