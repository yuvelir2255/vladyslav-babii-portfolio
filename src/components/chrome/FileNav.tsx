  ...
  return (
    <div ref={root} className="fixed top-3 left-1/2 z-50 -translate-x-1/2">
      <button
        ...
        className="flex min-h-[44px] items-center gap-3 rounded-full border border-[color-mix(in_srgb,var(--color-steel)_28%,transparent)] bg-[color-mix(in_srgb,var(--color-surface)_85%,transparent)] px-4 py-2.5 font-[family-name:var(--font-mono)] text-[12px] tracking-[0.14em] text-[var(--color-bone)] uppercase shadow-[0_6px_22px_-10px_rgba(0,0,0,0.7)] backdrop-blur transition-colors hover:border-[var(--color-orange)] focus-visible:border-[var(--color-orange)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-orange)]"
      >
      ...
      <nav
        ref={panelRef}
        aria-hidden={!open}
        className="grain invisible absolute top-[calc(100%+8px)] left-1/2 w-[230px] -translate-x-1/2 overflow-hidden rounded-xl border border-[color-mix(in_srgb,var(--color-steel)_24%,transparent)] bg-[color-mix(in_srgb,var(--color-surface)_94%,transparent)] p-2 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.85)] backdrop-blur"
      >
