...
export function PendingExhibit() {
  ...
  return (
    <div className="mt-14 border-t border-[var(--color-line)] pt-10 max-md:mt-10 max-md:pt-8">
      <div
        data-custody-row
        className="pending-slot group relative overflow-hidden rounded-xl border border-dashed border-[var(--color-line)] px-9 py-10 transition-colors hover:border-[var(--color-steel)] max-md:px-5 max-md:py-7"
      >
        ...
        <div className="relative flex items-center justify-between gap-8 max-sm:flex-col max-sm:items-start max-sm:gap-5">
          <div>
            <p className="font-[family-name:var(--font-mono)] text-[11px] tracking-[0.22em] text-[var(--color-dim)] uppercase">
              Next exhibit
            </p>
